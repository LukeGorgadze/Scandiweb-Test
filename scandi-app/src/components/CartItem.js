...
class CartItem extends React.Component {
    ...
    addToCartButton = () => {
        ...
        console.log(productItem,"Before storing CartItem" )
    }
    ...
    render() {
        ...
        return (
            (this.state.counter > 0 && (
                <div className="smallCart-Cart-Item">
                    <div className="smallCart-Cart-Item-Info">
                        <div className="smallCart-Cart-Item-Info-Header">{this.props.brand}</div>
                        <div className="smallCart-Cart-Item-Info-Title">{this.props.name}</div>
                        <div className="smallCart-Cart-Item-Info-Price">{this.props.priceSymbol} {this.props.priceAmount}</div>

                        <div className="smallCart-Cart-Item-Info-Attributes">
                            {
                                                ...
                                                <div className="attribute-section">
                                                    {val.attributeVals.map((v, index) => {
                                                        ...
                                                        return (
                                                            ...
                                                            <div className={isChosen ? `smallCart-Cart-Item-Info-Attributes-Color-active` :  !hasVal && index === 0 ? `smallCart-Cart-Item-Info-Attributes-Color-active` : `smallCart-Cart-Item-Info-Attributes-Color`} key={index}
                                                                style={{
                                                ...
                                                <div className="attribute-section">
                                                    {val.attributeVals.map((v, index) => {
                                                        ...
                                                        return (
                                                            ...
                                                            <div className={isChosen ? `smallCart-Cart-Item-Info-Attributes-atts-active` : !hasVal && index === 0 ? `smallCart-Cart-Item-Info-Attributes-atts-active` : `smallCart-Cart-Item-Info-Attributes-atts`} key={index}>
                                                                {v.value}
                                                            </div>
                                                        )
                                                    })}
                    ...
                    <div className="smallCart-Cart-Item-Info-AddNimages">
                        <div className="smallCart-Cart-Item-AddSection">
                        ...
                        <div className="smallCart-Cart-Item-Images">
